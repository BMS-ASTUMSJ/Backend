  ...
  try {
    ...
    if (!existingSubmission) {
      ...
      const populatedSubmission =
        await Submission.findById(
          ...
          .populate(
            "assignment",
            "title description deadline maxScore batch"
          )
          .populate(
            "student",
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "You cannot submit this assignment again unless your mentor requests a resubmission.",
      });
    }
  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Status must be Graded or Resubmission Required.",
      });
    }
    ...
    if (!assignment) {
      return res.status(404).json({
        success: false,
        message:
          "Assignment associated with this submission was not found.",
      });
    }
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Assignment has an invalid maximum score.",
      });
    }
    ...
    if (
      ...
      return res.status(403).json({
        success: false,
        message:
          "Only mentors and admins can grade submissions.",
      });
    }
